#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/ericsplugins/.vscode/extensions/wallabyjs.console-ninja-1.0.315/out/buildHook/index.js').default({tool: 'angular'}); } catch(cjsError) { try { import('file:///Users/ericsplugins/.vscode/extensions/wallabyjs.console-ninja-1.0.315/out/buildHook/index.js').then(m => m.default.default({tool: 'angular'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
